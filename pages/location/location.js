...
Page({
  ...
  onLoad: function (options) {
    ...
    // 组装活动类型
    var eventCategory = {};
    for (var idx in this.data.categoryName) {
  ...
  onShow: function () {
    // 页面显示
    console.log("onShow");
    console.log(app.globalData.reflesh)
    // 界面是否需要重新刷新
  ...
  getEventByLocationId: function (locId, dayType, eventType) {
    ...
    // var eventListURL = app.globalData.doubanBase + app.globalData.event_list_url;
    console.log(eventListURL);//https://api.douban.com/v2/event/list?loc=118282&&start=0&&count=50
